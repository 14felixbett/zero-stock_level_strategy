...
# and inserts them into the (stock_list) list and (production_quantity) list respectively
    if index == len(sales_quantity):
        break
print(f'The list of stock levels of each month, starting with the initial stock to the resulting stock of the following months till the last month to plan, is: \n{stock_list} \n')
